        ...
        >
          <div className="flex justify-between items-start border-b pb-3 mb-3">
            <div>
              ...
              <p className="text-sm text-gray-500 flex items-center mt-1">
                <Clock className="w-3 h-3 mr-1" /> Placed on:{" "}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 text-sm">
            <p className="font-bold flex items-center gap-1">
              <Package className="w-4 h-4 text-primary" /> {order.items.length}{" "}
              Items
            </p>
            <p className="font-bold flex items-center gap-1">
            ...
            <p className="col-span-2 text-xs text-gray-500 mt-2 md:mt-0">
